   ...
   (
     ...
     function updateSkill() {
       ...
       if (newSkill && isSkillValidInputs(newSkill)) {
         ...
         stepChange(null);
         selectedThemeChange(null);
       } else if (currentSkills.length < 1 || currentSkills.length > 4) {
         openModal(
           <InvalidModal
             onCloseModal={closeModal}
             text="Attention, il faut sélectionner minimum 1 compétences ou maximum 4 compétences!"
           />,
         );
       }
     }
     ...
     function onEditClick() {
       if (!selectedTheme) {
         ...
         const newSkill = newSkillRef.current;
         if (newSkill && (newSkill.competences.length < 1 || newSkill.competences.length > 4)) {
           openModal(
             <InvalidModal
               onCloseModal={closeModal}
               text="Attention, il faut sélectionner minimum 1 compétences ou maximum 4 compétences!"
